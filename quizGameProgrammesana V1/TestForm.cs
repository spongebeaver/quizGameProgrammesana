...
namespace quizGameProgrammesana_V1
{
    public partial class TestForm : Form
    {
        ...
        public TestForm(DatabaseManager dbManager)
        {
            InitializeComponent();
        ...
        public TestForm(DatabaseManager dbManager, string username) : this(dbManager)
        {
        ...
        private void SaveScoreToDatabase()
        {
            ...
            {
                string query = "UPDATE Players SET Score = Score + @score WHERE Name = @username";
